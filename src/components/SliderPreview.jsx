...
const SliderPreview = ({ handleSlider, titulo, position, image }) => {
  const style = {
    top: `${position.y}rem`,
    left: `${position.x}rem`,
  }
  ...
  return (
    <div
      style={style}
      className='slider-container absolute flex h-[29.275rem] w-[47.5rem] flex-col items-center justify-between bg-white p-1'>
